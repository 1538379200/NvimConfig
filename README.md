...
- 使用 ```:TSInstall``` 安装需要的语言支持，比如 ```:TSInstall markdown```  ```:TSInstall toml```  ```TSInstall json``` 等，你可以去 [treesitter](https://github.com/nvim-treesitter/nvim-treesitter#supported-languages)查看支持的语言类型
